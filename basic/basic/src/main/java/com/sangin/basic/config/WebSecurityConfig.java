...
import com.sangin.basic.provider.OAuth2SuccessHandler;
import com.sangin.basic.service.implement.OAuth2UserServiceImplement;
...
class FailedAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        response.setContentType("application/json;charset=UTF-8");       // ;charset=UTF-8 : 한국어 패치 입력
